...
class FitMorphSettings(Enum):
    ...
    WAIST = FitMorphSetting(
        ...
        child_move_morph_names=["下半身", "上半身", "上半身2", "首根元", "首", "胸"],
        child_rotation_morph_names=[],
        child_scale_morph_names=["下半身", "上半身", "上半身2", "首根元", "首"],
    ...
    UPPER = FitMorphSetting(
        ...
        move_target_bone_names=[],
        child_move_morph_names=["胸", "上半身2", "首根元", "首"],
        child_rotation_morph_names=[],
        child_scale_morph_names=["上半身2", "首根元", "首"],
        attend_weight_bone_names=[],
    )
    ...
    UPPER2 = FitMorphSetting(
        ...
        move_target_bone_names=[],
        child_move_morph_names=["胸", "首根元", "首"],
        child_rotation_morph_names=[],
    ...
    ARM = FitMorphSetting(
        ...
        child_move_morph_names=["ひじ", "手首"],
        child_rotation_morph_names=["ひじ", "手首"],
        child_scale_morph_names=["ひじ", "手首"],
        attend_weight_bone_names=[],
    )
    ...
    ELBOW = FitMorphSetting(
        ...
        child_move_morph_names=["手首"],
        child_rotation_morph_names=["手首"],
        child_scale_morph_names=["手首"],
        attend_weight_bone_names=[],
    )
