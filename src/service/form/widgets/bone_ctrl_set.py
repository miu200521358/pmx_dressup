...
class BoneCtrlSet:
    ...
    def initialize(self):
        ...
        self.scale_x_slider.SetValue(0.0)
        self.scale_y_slider.SetValue(0.0)
        self.scale_z_slider.SetValue(0.0)
        self.degree_x_slider.SetValue(0.0)
        self.degree_y_slider.SetValue(0.0)
        self.degree_z_slider.SetValue(0.0)
        self.position_x_slider.SetValue(0.0)
        self.position_y_slider.SetValue(0.0)
    ...
    def on_change_bone(self, event: wx.Event):
        ...
        self.scale_x_slider.SetValue(self.scales[bone_name].x)
        self.scale_y_slider.SetValue(self.scales[bone_name].y)
        self.scale_z_slider.SetValue(self.scales[bone_name].z)
        self.degree_x_slider.SetValue(self.degrees[bone_name].x)
        self.degree_y_slider.SetValue(self.degrees[bone_name].y)
        self.degree_z_slider.SetValue(self.degrees[bone_name].z)
        self.position_x_slider.SetValue(self.positions[bone_name].x)
        self.position_y_slider.SetValue(self.positions[bone_name].y)
        self.position_z_slider.SetValue(self.positions[bone_name].z)
