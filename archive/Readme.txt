...
　材質の非透過度を1未満に設定すると、お着替えモデルに出力しません
...
　　・衣装のメッシュが準標準以外にウェイトが乗っている場合、変形が綺麗にならない場合があります
...
　・prime_for_fitting　　　…　材質補填用素体（VRoid製）
...
----------------------------------------------------------------
 ...
 【おまけ】
   「prime_for_fitting」フォルダ内のモデルデータは VRoid Studio で私が作成した素体モデルです。
