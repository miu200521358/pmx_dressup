...
PmxDressup_1.00.03_β08 (2024/02/10)
・フィッティング処理時にnanが発生する場合があったのを修正

PmxDressup_1.00.03_β07 (2024/01/20)
・剛体の出力可否条件を追加
・設定画面表示時のボーンハイライトで選択肢が無い場合にスルーするよう修正

PmxDressup_1.00.03_β06 (2024/01/19)
・上半身3がないモデルで解析に失敗する場合があったのを修正(その2）

PmxDressup_1.00.03_β05 (2024/01/12)
・上半身3がないモデルで解析に失敗する場合があったのを修正

PmxDressup_1.00.03_β04 (2024/01/10)
・準標準外ボーンを個別に調整できる選択肢を追加
・上半身のウェイト調整
・準標準外ボーンが同一位置の準標準ボーンの縮尺を参照する際に、ウェイトボーンが見つからず、かつ腕ボーンがある場合に腕を優先させるよう調整
・反転ボタン追加（準標準外ボーンで「左右」が名前にある場合、反対のボーンに設定値をコピペする）
・下半身より上の準標準ボーンはローカル軸を強制再設定するよう修正

PmxDressup_1.00.03_β03 (2023/12/01)
・基本ライブラリ更新
・プレビュー画面の処理速度UP
